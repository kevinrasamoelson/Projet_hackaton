    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form action="inscription_traitement.php" method="post">
                ...
                <input type="text" name="nom" id="nom" placeholder="Lucas Hernandez" required>
                <input type="email" name="email" placeholder="user@gmail.com" required>
                <input type="number" name="numero" id="numero" placeholder=" +261 XX XXX XX" required>
