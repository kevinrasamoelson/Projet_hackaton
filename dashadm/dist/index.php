...
<div class="app-container">
  <div class="sidebar">
    ...
    <div class="account-info">
      ...
      <div class="account-info-name">Boulangerie</div>
  ...
  <div class="app-content">
    <div class="app-content-header">
      ...
      <a href="nouveau.php" class="btn btn-success">Ajouter un nouveau produit</a>
    </div>
    ...
    <div class="products-area-wrapper tableView">
      <div class="products-header">
        ...
        <div class="product-cell status-cell">Details<button class="sort-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z"/></svg>
          </button></div>
        ...
        <div class="product-cell stock">Stock<button class="sort-button">
          ...
          <div class="product-cell stock">Action<button class="sort-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z"/></svg>
          </button></div>
      ...
      <div class="products-row">
        <button class="cell-more-button">
          ...
          <div class="product-cell image">
            <img src="data:image/jpeg;base64,<?php echo base64_encode($voiture['PHOTO1']); ?>"><span></span>
          </div>
        <div class="product-cell category"><span class="cell-label">Category:</span><?php echo $voiture['NOM'] ?></div>
        
        <div class="product-cell sales"><span class="cell-label">Details:</span><?php echo $voiture['DETAIL'] ?></div>
        <div class="product-cell price"><span class="cell-label">Prix:</span><?php echo $voiture['PRIX'] ?>  Ar</div>
        <div class="product-cell price"><span class="cell-label">Price:</span><?php echo $voiture['STOCK'] ?></div>
        <div class="product-cell category">
        <form method="post" action="update_page.php">
            <input type="hidden" name="id" value="<?php echo $voiture['ID'] ?>">
            <button type="submit" class="btn btn-info" name="update_voiture"><i class="fas fa-edit"></i></button>
          </form>
          <span>&nbsp; &nbsp;</span>
          <form method="post" action="delete.php">
            <input type="hidden" name="id" value="<?php echo $voiture['ID'] ?>">
            <button type="submit" class="btn btn-danger" name="delete_voiture"><i class="fas fa-trash"></i></button>
          </form>
        </div>
