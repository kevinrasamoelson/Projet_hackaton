    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-up">
            <form action="inscription_traitement.php" method="post">
                ...
                <input type="text" name="email" placeholder="utilisateurs@gmail.com" required>
                <input type="number" name="code_admine" id="code_admine" placeholder="****" required>
                <input type="password" name="mots_de_passe" placeholder="******" required>
